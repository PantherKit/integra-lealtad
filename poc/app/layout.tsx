...
const TITLE = 'Coutiño Lealtad — POC';
const DESCRIPTION =
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: DESCRIPTION,
    url: SITE_URL,
    siteName: 'Coutiño Lealtad',
    locale: 'es_MX',
    type: 'website',
    images: [{ url: '/og.png', width: 1200, height: 630, alt: 'Coutiño Lealtad — POC navegable' }],
  },
  twitter: {
      ...
      <body className="min-h-screen flex flex-col">
        <header className="border-b border-gray-200/70 bg-white/80 backdrop-blur sticky top-0 z-30">
          <div className="max-w-6xl mx-auto px-4 h-14 flex items-center gap-6">
            <Link href="/" className="flex items-center gap-2 font-semibold tracking-tight">
              <span className="w-6 h-6 rounded-md bg-gradient-to-br from-brand-500 to-amber-300 grid place-items-center text-white text-xs font-bold">C</span>
              Coutiño <span className="text-brand-600">Lealtad</span>
            </Link>
        ...
        <footer className="border-t border-gray-200 bg-white">
          <div className="max-w-6xl mx-auto px-4 py-3 text-xs text-gray-500 flex justify-between">
            ...
            <span>Confidencial — Coutiño</span>
          </div>
        </footer>
      </body>
    </html>
